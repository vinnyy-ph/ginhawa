...
**Goal:** Create a dedicated `/features` page for the Ginhawa telehealth application using a "Narrative Journey" layout, replacing the existing anchor link on the landing page.

**Architecture:** A Next.js App Router Server Component leveraging the existing `@/components/ui/fade-in` component for scroll animations. The page consists of a Hero section, four alternating "Journey" steps (Text/Graphic), and a concluding CTA section.

**Tech Stack:** Next.js (App Router), React, Tailwind CSS, Radix UI Icons.

---

### Task 1: Create the Features Page and Hero Section

**Files:**
- Create: `frontend/src/app/features/page.tsx`

- [ ] **Step 1: Scaffold the page and implement the Hero Section**
...
- [ ] **Step 2: Commit the base page**

```bash
git add frontend/src/app/features/page.tsx
git commit -m "feat: create features page with hero section"
```

### Task 2: Implement the Narrative Journey Steps

**Files:**
- Modify: `frontend/src/app/features/page.tsx`

- [ ] **Step 1: Add the journey steps to the main element**
...
// ... inside the file, below the Hero Section and above the CTA ...
...
- [ ] **Step 2: Commit the journey steps**

```bash
git add frontend/src/app/features/page.tsx
git commit -m "feat: add narrative journey steps to features page"
```

### Task 3: Implement the Call-to-Action Section

**Files:**
- Modify: `frontend/src/app/features/page.tsx`

- [ ] **Step 1: Add the CTA block at the bottom and import Link and Button**
...
```bash
git add frontend/src/app/features/page.tsx
git commit -m "feat: add CTA section to features page"
```
...
- Modify: `frontend/src/components/layout/footer.tsx` (if a features link exists there)

- [ ] **Step 1: Update Header Link**

Change `href="#features"` to `href="/features"` in `frontend/src/components/layout/header.tsx`:
...
git commit -m "fix: point features nav link to new dedicated page"
```